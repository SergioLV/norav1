      ...
      <div className={`container ${styles.layout}`}>
        <div className={styles.left}>
          ...
          <p className={styles.resolve}>
            No faltan pacientes. Falta <span className={styles.hl}>compromiso previo</span>.
          </p>
          <a href="#cta" className="btn-primary" style={{ marginTop: '0.75rem' }}>Reducir mis plantones →</a>
        </div>
